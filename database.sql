...
-- Cara pakai:
--   1. Buat database baru bernama smart_event_campus
--      (di InfinityFree nama db otomatis diawali if0_xxxxx_)
--   2. Buka phpMyAdmin, pilih database tersebut (klik nama database
--      di sidebar kiri sampai warna kotaknya jadi aktif/terpilih)
--   3. Klik tab "Import" di bagian atas, pilih file ini, klik "Go"
-- =========================================================
